...
2. Скачайте файл `Voltaris-Setup-1.0.0.exe` и установите приложение.
...
> [!IMPORTANT]
> Установщик версии 1.0.0 пока не подписан цифровым сертификатом. Windows SmartScreen может показать предупреждение. Загружайте файл только со страницы релизов этого репозитория.
...
- `artifacts/installer/Voltaris-Setup-1.0.0.exe` — установщик для текущего пользователя.
